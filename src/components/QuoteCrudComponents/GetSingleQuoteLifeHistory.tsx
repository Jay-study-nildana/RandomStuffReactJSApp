...
//note - this was built using UpdateExistingQuote as a template.
...
interface GetQuoteLifeHistoryBody {
...
// @ts-ignore
function DisplayHelper({ token, triggerapi, readytoroll, quoteIdentifierString }) {
    ...
    const endPoint = "/api/Moderator/GetQuoteAlongWithItsLifeStory";
    ...
    let body: GetQuoteLifeHistoryBody = { quoteIdentifier: quoteIdentifierString };
...
const GetSingleQuoteLifeHistory = () => {
    ...
    }, [readytoroll, quoteIdentifierString]);
...
export default GetSingleQuoteLifeHistory;